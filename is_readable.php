...
if ( isset($_POST['checkIsFileReadableOrNot'])){

$fileName = $_POST['fileName'];
$upload = new Upload();
$upload -> checkIsFileReadableOrNot( $fileName );
...
?>
  					...
  					<div class="form-group">
  						<button class="btn btn-primary" name="checkIsFileReadableOrNot">Check is file readable or not </button>
  					</div>
  				</form>
  			</div>
  		</div>
