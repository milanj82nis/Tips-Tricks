...
<html lang="en">
  <head>
    ...
    <title>FILESIZE PHP FUNCTION</title>
  </head>
  <body>
  	<div class="container">
...
<div class="form-group">
	<button class="btn btn-primary" name="getFileSize">Get file size</button>
</div>
